...
/*   Updated: 2022/02/03 18:27:48 by mdesalle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Server
{
	public:
		...
		std::map<std::string, std::vector<size_t> >		GetDefaultServer(void)		const;
		std::map<std::string, std::vector<size_t> >		GetListenIPandPorts(void)	const;
